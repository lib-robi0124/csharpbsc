...
Console.WriteLine("1) Empty DateTime: " + dt);

// 2) Creating custom date
DateTime customDate = new DateTime(1972, 08, 24, 12, 30, 0);
Console.WriteLine("2) Custom Date: " + customDate);

// 3) creating a DateTime with current date and time
DateTime now = DateTime.Now;
DateTime today = DateTime.Today;
Console.WriteLine("3) Current Date and Time: " + now);
Console.WriteLine("3) Current Date: " + today);
...
string stringDate = "12.03.2024 12:34:24";
DateTime.TryParse(stringDate, out DateTime parsedDate);
Console.WriteLine("4) Parsed Date: " + parsedDate);
